...
# допишите код: напишите конструктор,
class Mountain(Point):
    ...
    def __init__(self, latitude, longitude, name, height):
        ...
        self.name = name
        self.height = height
        # в нём сохраните свойства родителя
        super().__init__(latitude, longitude)
    ...
    def show(self):
        ...
        return f"Высота горы {self.name} - {self.height} м."
...
armavir = City(44.5941, 41.0746, 'Армавир', 200_000)

moscow.show()
everest.show()
print_how_far(moscow, everest)
print_how_far(moscow, armavir)